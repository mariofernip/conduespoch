...
/* administrativoBundle:Default:nivel_modificar.html.twig */
class __TwigTemplate_1fbaa412f21c14537b4dd607274a5d91c3b25057915985155197fd6ec0c0af89 extends Twig_Template
{
    ...
    {
        echo "Registro de un nuevo curso";
    }
...
<form action=\"";
        // line 14
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_nivel_modificar", array("codnivel" => (isset($context["codnivel"]) ? $context["codnivel"] : $this->getContext($context, "codnivel")))), "html", null, true);
        echo "\" method=\"post\" ";
        echo         // line 15
$this->env->getExtension('form')->renderer->searchAndRenderBlock((isset($context["formulario"]) ? $context["formulario"] : $this->getContext($context, "formulario")), 'enctype');
        ...
        echo "
          <fieldset>
                  ...
                  ";
        // line 19
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["formulario"]) ? $context["formulario"] : $this->getContext($context, "formulario")), "curso"), 'label', array("label" => "Nivel:"));
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["formulario"]) ? $context["formulario"] : $this->getContext($context, "formulario")), "curso"), 'errors');
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["formulario"]) ? $context["formulario"] : $this->getContext($context, "formulario")), "curso"), 'widget', array("attr" => array("autocomplete" => "off")));
        echo "<br>                  
                  ";
        // line 20
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["formulario"]) ? $context["formulario"] : $this->getContext($context, "formulario")), "paralelo"), 'label', array("label" => "Paralelo:"));
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["formulario"]) ? $context["formulario"] : $this->getContext($context, "formulario")), "paralelo"), 'errors');
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["formulario"]) ? $context["formulario"] : $this->getContext($context, "formulario")), "paralelo"), 'widget', array("attr" => array("autocomplete" => "off")));
        echo "<br>                  
...
<hr>
<strong><p align=\"center\">LISTA CURSOS</p></strong>
<div id=\"dt_example\">
    <div id=\"demo\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["m"]) {
            ...
            echo "                        
                        <tr >
                            <td>";
            // line 46
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["m"]) ? $context["m"] : $this->getContext($context, "m")), "curso"), "html", null, true);
            echo "</td> <td>";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["m"]) ? $context["m"] : $this->getContext($context, "m")), "paralelo"), "html", null, true);
            echo "</td><td>";
            ...
            echo "</td> <td><a href=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_nivel_modificar", array("codnivel" => $this->getAttribute((isset($context["m"]) ? $context["m"] : $this->getContext($context, "m")), "id"))), "html", null, true);
            echo "\">Mod</a></td>                        
...
";
 ...
 ";
    ...
    {
        return "administrativoBundle:Default:nivel_modificar.html.twig";
    }
