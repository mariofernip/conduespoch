...
/* administrativoBundle:Default:listahoras.html.twig */
class __TwigTemplate_2f8d0f6fe46662df92f3ac54b9a88ba2a287fdbb1b15b8208a1458359df839c1 extends Twig_Template
{
        ...
        <table class=\"display\" id=\"example\">
            <thead>
                <tr >
                    <th>";
            // line 17
            echo "Hora de inicio -- Hora de finalizacion";
            echo "</th>             
                    <th>";
            // line 18
            echo "Descripcion";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["hor"]) {
                ...
                // line 28
                echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("hora_modificar_id", array("hid" => $this->getAttribute((isset($context["hor"]) ? $context["hor"] : $this->getContext($context, "hor")), "id"))), "html", null, true);
...
";
   ...
   ";
    ...
    {
        return "administrativoBundle:Default:listahoras.html.twig";
    }
